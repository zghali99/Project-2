...
This Project will explore these two major market competitors. I will use two databses where each of them contains a list of movies and shows broadcasted by each of them, then I will show a list of movies and shows that both ... have as well as unique movies and shows that they each have that the other does not. 
